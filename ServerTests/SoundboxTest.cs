...
namespace Soundbox.Test
{
    ...
    {
        public SoundboxTestWrapper(IServiceProvider serviceProvider, IHubContext<SoundboxHub, ISoundboxClient> hubContext, IConfiguration config) : base(serviceProvider, hubContext, config)
        {
        }
